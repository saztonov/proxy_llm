...
2. **Выбирать модель осознанно:** оставить реальный слаг, но помнить, что fallback отключится, и обрабатывать `400 model_not_allowed`. Рецепт — §9 скилла `.claude/skills/connect-proxy-llm/`.
